...
envs = [Environment(device='/gpu:0'.format(i),agent_id=i) for i in range(THREADS)]
opts = [Optimizer(device='/gpu:0'.format(i+7), optimizer_id=i) for i in range(OPTIMIZERS)]
